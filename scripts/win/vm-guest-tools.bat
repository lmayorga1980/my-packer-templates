...
if not exist "C:\Windows\Temp\VBoxGuestAdditions.iso" (
    powershell -Command "(New-Object System.Net.WebClient).DownloadFile('https://download.virtualbox.org/virtualbox/6.0.14/VBoxGuestAdditions_6.0.14.iso', 'C:\Windows\Temp\VBoxGuestAdditions.iso')" <NUL
)
